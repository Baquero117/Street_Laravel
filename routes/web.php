...
Route::get('/verificar-cuenta', [VerificacionController::class, 'mostrar'])->name('verificacion.mostrar');
Route::post('/verificar-cuenta', [VerificacionController::class, 'validar'])->name('verificacion.validar');
Route::post('/verificar-cuenta/reenviar', [VerificacionController::class, 'reenviar'])->name('verificacion.reenviar');

Route::get('/recuperar-contrasena', [RecuperacionController::class, 'mostrarSolicitud'])->name('recuperacion.solicitud');
Route::post('/recuperar-contrasena', [RecuperacionController::class, 'procesarSolicitud'])->name('recuperacion.procesar-solicitud');
Route::get('/restablecer-contrasena', [RecuperacionController::class, 'mostrarRestablecimiento'])->name('recuperacion.restablecer');
Route::post('/restablecer-contrasena', [RecuperacionController::class, 'procesarRestablecimiento'])->name('recuperacion.procesar-restablecimiento');
...
Route::middleware(['checkAuth'])->group(function () {
    ...
    // Administrador
    Route::get('/admin', fn() => view('Administrador.InicioAdmin.InicioAdmin'))->name('admin.inicio');
    ...
    Route::get('/detalle_producto/buscar', [DetalleProductoController::class, 'buscar'])->name('detalle_producto.buscar');
    ...
    Route::post('/pedido/cambiar-estado', [PedidoController::class, 'cambiarEstado'])->name('pedido.cambiarEstado');
