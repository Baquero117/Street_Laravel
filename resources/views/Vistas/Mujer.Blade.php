        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                <div class="d-flex justify-content-center gap-3">
                    <img src="{{ asset('img/OtrasVistas/Mujer/blusa-satin2.jpg') }}" class="d-block w-25 rounded" alt="Producto 1">
                    <img src="{{ asset('img/OtrasVistas/Mujer/blusa-satin.jpg') }}" class="d-block w-25 rounded" alt="Producto 2">
                    <img src="{{ asset('img/OtrasVistas/Mujer/blusa-satin3.jpg') }}" class="d-block w-25 rounded" alt="Producto 3">
                </div>
            </div>

            <div class="carousel-item">
                <div class="d-flex justify-content-center gap-3">
                    <img src="{{ asset('img/OtrasVistas/mujer/baggy-azul2.jpg') }}" class="d-block w-25 rounded" alt="Producto 4">
                    <img src="{{ asset('img/OtrasVistas/mujer/baggy-azul.jpg') }}" class="d-block w-25 rounded" alt="Producto 5">
                    <img src="{{ asset('img/OtrasVistas/mujer/baggy-azul3.jpg') }}" class="d-block w-25 rounded" alt="Producto 6">
                </div>
            </div>

            <div class="carousel-item">
                <div class="d-flex justify-content-center gap-3">
                    <img src="{{ asset('img/OtrasVistas/mujer/camisa-azul2.jpg') }}" class="d-block w-25 rounded" alt="Producto 7">
                    <img src="{{ asset('img/OtrasVistas/mujer/camisa-azul.jpg') }}" class="d-block w-25 rounded" alt="Producto 8">
                    <img src="{{ asset('img/OtrasVistas/mujer/camisa-azul3.jpg') }}" class="d-block w-25 rounded" alt="Producto 9">
                </div>
            </div>
...
<div class="container-fluid bg-light text-dark py-5 mt-2">
    <div class="container">
        <h2 class="text-center mb-4">El mejor catálogo en ropa femenina</h2>
                ...
                <div class="col-md-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body text-center">
                            ...
                            <button class="btn btn-dark ver-detalle-mujer" data-id="{{ $producto['id_producto'] }}">
                                Ver más
                            </button>
                        </div>
                    </div>
            ...
            @empty
                <div class="col-12">
                    <div class="alert alert-info text-center">
                        No hay productos de mujer disponibles en este momento
                    </div>
                </div>
            @endforelse
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-dark text-white">
                    <h5 class="modal-title" id="modalNombreMujer"></h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <img id="modalImagenMujer" src="" class="img-fluid rounded" alt="">
                        </div>
                        <div class="col-md-6">
                            <p id="modalDescripcionMujer"></p>
                            <p><strong>Color:</strong> <span id="modalColorMujer"></span></p>
                            <p><strong>Precio:</strong> <span class="text-success fw-bold fs-4">$<span id="modalPrecioMujer"></span></span></p>
                            <div class="mb-3">
                                <strong>Tallas disponibles:</strong>
                                <div id="modalTallasMujer" class="mt-2"></div>
                            </div>
                            <button class="btn btn-success w-100" onclick="agregarAlCarritoMujer()">
