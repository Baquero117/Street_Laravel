        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                <div class="d-flex justify-content-center gap-3">
                    <img src="{{ asset('img/OtrasVistas/Hombre/camisa-gris2.jpg') }}" class="d-block w-25 rounded" alt="Producto 1">
                    <img src="{{ asset('img/OtrasVistas/Hombre/camisa-gris.jpg') }}" class="d-block w-25 rounded" alt="Producto 2">
                    <img src="{{ asset('img/OtrasVistas/Hombre/camisa-gris3.jpg') }}" class="d-block w-25 rounded" alt="Producto 3">
                </div>
            </div>

            <div class="carousel-item">
                <div class="d-flex justify-content-center gap-3">
                    <img src="{{ asset('img/OtrasVistas/Hombre/camisa-negra2.jpg') }}" class="d-block w-25 rounded" alt="Producto 4">
                    <img src="{{ asset('img/OtrasVistas/Hombre/camisa-negra.jpg') }}" class="d-block w-25 rounded" alt="Producto 5">
                    <img src="{{ asset('img/OtrasVistas/Hombre/camisa-negra3.jpg') }}" class="d-block w-25 rounded" alt="Producto 6">
                </div>
            </div>

            <div class="carousel-item">
                <div class="d-flex justify-content-center gap-3">
                    <img src="{{ asset('img/OtrasVistas/Hombre/oversize-negra.jpg') }}" class="d-block w-25 rounded" alt="Producto 7">
                    <img src="{{ asset('img/OtrasVistas/Hombre/oversize-negra3.jpg') }}" class="d-block w-25 rounded" alt="Producto 8">
                    <img src="{{ asset('img/OtrasVistas/Hombre/oversize-negra2.jpg') }}" class="d-block w-25 rounded" alt="Producto 9">
                </div>
            </div>
