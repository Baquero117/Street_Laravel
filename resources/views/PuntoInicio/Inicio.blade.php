                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <div class="d-flex justify-content-center gap-3">
                            ...
                            <img src="{{ asset('img/PuntoInicio/1.chaquetaGris.jpg') }}" class="carousel-image rounded" alt="Producto 2">
                            <img src="{{ asset('img/PuntoInicio/3.chaquetaGris.jpg') }}" class="carousel-image rounded" alt="Producto 3">
                        </div>
                    </div>
                    ...
                    <div class="carousel-item">
                        <div class="d-flex justify-content-center gap-3">
                            ...
                            <img src="{{ asset('img/PuntoInicio/1.chaquetaCafe.jpg') }}" class="carousel-image rounded" alt="Producto 5">
                            <img src="{{ asset('img/PuntoInicio/3.chaquetaCafe.jpg') }}" class="carousel-image rounded" alt="Producto 6">
                        </div>
                    </div>
                    ...
                    <div class="carousel-item">
                        <div class="d-flex justify-content-center gap-3">
                            ...
                            <img src="{{ asset('img/PuntoInicio/1.chaquetaNegra.jpg') }}" class="carousel-image rounded" alt="Producto 8">
                            <img src="{{ asset('img/PuntoInicio/3.chaquetaNegra.jpg') }}" class="carousel-image rounded" alt="Producto 9">
                        </div>
                    </div>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-5 d-flex flex-column p-4 p-lg-5" style="max-height: 90vh; overflow-y: auto;">
                            ...
                            <div class="mb-4">
                                ...
                                <div id="modalTallas" class="d-flex flex-wrap gap-2">
                                    </div>
                            </div>
