            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <div class="carousel-images-wrapper">
                        <img src="{{ asset('img/PuntoInicio/2.chaquetaGris.jpg') }}" class="carousel-image rounded" alt="Producto 1">
                        <img src="{{ asset('img/PuntoInicio/1.chaquetaGris.jpg') }}" class="carousel-image rounded d-none d-md-block" alt="Producto 2">
                        <img src="{{ asset('img/PuntoInicio/3.chaquetaGris.jpg') }}" class="carousel-image rounded d-none d-lg-block" alt="Producto 3">
                    </div>
                </div>

                <div class="carousel-item">
                    <div class="carousel-images-wrapper">
                        <img src="{{ asset('img/PuntoInicio/2.chaquetaCafe.jpg') }}" class="carousel-image rounded" alt="Producto 4">
                        <img src="{{ asset('img/PuntoInicio/1.chaquetaCafe.jpg') }}" class="carousel-image rounded d-none d-md-block" alt="Producto 5">
                        <img src="{{ asset('img/PuntoInicio/3.chaquetaCafe.jpg') }}" class="carousel-image rounded d-none d-lg-block" alt="Producto 6">
                    </div>
                </div>

                <div class="carousel-item">
                    <div class="carousel-images-wrapper">
                        <img src="{{ asset('img/PuntoInicio/2.chaquetaNegra.jpg') }}" class="carousel-image rounded" alt="Producto 7">
                        <img src="{{ asset('img/PuntoInicio/1.chaquetaNegra.jpg') }}" class="carousel-image rounded d-none d-md-block" alt="Producto 8">
                        <img src="{{ asset('img/PuntoInicio/3.chaquetaNegra.jpg') }}" class="carousel-image rounded d-none d-lg-block" alt="Producto 9">
                    </div>
                </div>
                        ...
                        <div class="card-body px-0 pt-3 pb-2">
                            ...
                            <div class="mt-2">
                                <small class="text-muted">
                                    <span class="color-indicator"></span> +{{ $producto['colores_count'] ?? 1 }}
                                </small>
                            </div>
                            @endif
                        </div>
