...
class MujerController extends Controller
{
    ...
    {
        try {
            // 👇 Llama al endpoint que filtra por categoría 21
            $response = Http::get("{$this->apiUrl}/producto/categoria/21");
            ...
            $productos = [];
            Log::error('Error al obtener productos de mujer: ' . $e->getMessage());
        }

        return view('Vistas.Mujer', compact('productos'));
    }
