...
class ModaController extends Controller
{
    ...
    {
        try {
            // 👇 Llama al endpoint que filtra por categoría 22
            $response = Http::get("{$this->apiUrl}/producto/categoria/22");
            ...
            $productos = [];
            Log::error('Error al obtener productos de moda: ' . $e->getMessage());
        }

        return view('Vistas.Moda', compact('productos'));
    }
